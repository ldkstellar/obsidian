...
```cpp
std::shared_ptr<Person> lockedOwner = weak.Owner.lock();
```
...
![[Pasted image 20250714151742.png]]
안전할까? 사례1인 경우에는 멀티스레딩환경에서중간에 strong참조가 0이되는 경우가 있기 때문이다.
![[Pasted image 20250714152113.png]]![[Pasted image 20250721234048.png]]
### 결론
메모리와 오브젝트가 반드시 같이 가는 것은 아니다. weak ptr이0일때 컨트롤 메모리 해제 한다..


![[Pasted image 20250722000829.png]]